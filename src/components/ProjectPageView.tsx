              ...
              <div className="max-w-5xl">
                ...
                <ul className="list-disc pl-10 text-gray-700 dark:text-gray-300 mb-6">
                  <li>
                    ...
                    extractor. This lightweight but powerful architecture
                    provides a strong foundation for our classification task.
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-10 text-gray-700 dark:text-gray-300 mb-6 space-y-1">
                  ...
                  <ul className="list-disc pl-12 space-y-1">
                    ...
                    <li>
                      Fine-tuning phase with last 5 blocks of MobileNetV2
                      unfrozen
                    </li>
                  </ul>
                  <li>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card className="p-6 dark:bg-zinc-800 dark:border-zinc-700">
                  ...
                  <ul className="space-y-2">
                    {project.technicalDetails.technologies.map(
                      (tech, index) => (
                        <li
                          key={index}
                ...
                <Card className="p-6 dark:bg-zinc-800 dark:border-zinc-700">
                  ...
                  <ul className="space-y-2">
                    {project.technicalDetails.challenges.map(
                      (challenge, index) => (
                        <li
                          key={index}
