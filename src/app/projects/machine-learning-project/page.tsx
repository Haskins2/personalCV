          ...
          <div className="max-w-6xl mx-auto mb-12">
            <div className="max-w-5xl mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                In this group project, we developed a reinforcement learning
                agent for the Atari-style game Knights-Archers-Zombies (KAZ).
                Utilising the PettingZoo KAZ environment and the RLlib
                framework, we implemented the Proximal Policy Optimisation (PPO)
                algorithm. A key component of our approach is our inclusion of
                manual feature engineering, transforming raw environment states
                into a more meaningful feature vectors for the model to learn
                from.
              </p>
            </div>
            ...
            <h3 className="text-2xl font-semibold mt-8 dark:text-white mb-4">
              Results
            </h3>
            Our trained agent&apos;s performance was submitted to a course
            leaderboard, with over 50 teams of 2 entered. With our final
            submission, we were placed 15th in the competition, demonstrating
            solid performance & placing us in the top 30% of all participating
            teams.
          </div>
        </div>
      </div>
