      ...
      <div className="bg-zinc-50 dark:bg-zinc-900 min-h-screen">
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="max-w-6xl mx-auto mb-12">
            ...
            <div className="relative w-2/3 h-96 lg:h-[420px] rounded-lg overflow-hidden shadow-lg mb-4 mx-10">
              <Image
                src="/example.jpg"
                alt="Computer Vision project overview"
                fill
            ...
            <div className="relative w-2/3 h-96 lg:h-[420px] rounded-lg overflow-hidden shadow-lg mb-8 mt-3 mx-10">
              <Image
                src="/bad_example.jpg"
                alt="Computer Vision project overview"
                fill
