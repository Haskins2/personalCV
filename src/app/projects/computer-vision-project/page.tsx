          ...
          <div className="max-w-6xl mx-auto mb-12">
            <div className="max-w-5xl">
              <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed text-left mb-6">
                This project uses the PASCAL VOC 2009 dataset, consisting of
                colour images with different object classes (e.g. animal:{" "}
                <em>bird, cat, ...</em>; vehicle:{" "}
                <em>aeroplane, bicycle, ...</em>), totalling 20 classes. We
                developed and trained an end to end neural network for
                classifying these objects using a fine-tuned version
                MobileNetV2.
              </p>
              ...
              <ul className="list-disc pl-10 text-gray-700 dark:text-gray-300 mb-6">
                <li>
                  MobileNetV2 pre-trained on ImageNet serves as our feature
                  extractor. This lightweight but powerful architecture provides
                  a strong foundation for our classification task.
                </li>
              </ul>
              ...
              <ul className="list-disc pl-10 text-gray-700 dark:text-gray-300 mb-6 space-y-1">
                ...
                <li>
                  Final Dense layer with sigmoid activation for multi-label
                  classification
                </li>
              </ul>
              ...
              <ul className="list-disc pl-10 text-gray-700 dark:text-gray-300 mb-6 space-y-1">
                ...
                <li>
                  Learning rate reduction during fine-tuning (50% of initial
                  rate)
                </li>
                <li>
              ...
              <ul className="list-disc pl-10 text-gray-700 dark:text-gray-300 mb-6 space-y-1">
                <li>
                  Class-weighted loss function was implemented to handle the
                  severe class imbalance.
                </li>
                <li>
                  Data augmentation pipeline was used to improve model
                  robustness and prevent overfitting on limited training
                  dataset.
                </li>
              </ul>
              ...
              <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-6">
                Our final system achieved a mean F1 score of 0.83, reflecting
                good overall per-image multi-label performance. The below images
                show two good predictions from our model.
              </p>
            </div>
            ...
            <div className="max-w-5xl mb-6">
              <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                The following examples illustrate some of the model&apos;s
                incorrect predictions, highlighting the types of challenges and
                limitations that impacted overall performance. Here we could
                criticise the ground truth, asking questions such as &quot;Is it
                fair to be penalising the model if objects are so heavily
                obstructed?&quot;
              </p>
            </div>
