      ...
      <div className="bg-zinc-50 dark:bg-zinc-900 min-h-50">
        ...
        <div className="mb-8">
          <div className="max-w-6xl mx-auto flex items-start justify-between">
            ...
            <Link href="https://github.com/Haskins2" target="_blank" rel="noopener noreferrer">
              <Button className="bg-gray-800 hover:bg-gray-700 text-white dark:bg-gray-200 dark:hover:bg-gray-300 dark:text-black flex items-center mt-1">
