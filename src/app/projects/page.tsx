      ...
      <div className="bg-zinc-50 dark:bg-zinc-900 min-h-screen">
        ...
        <div className="mb-8">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start justify-between gap-4">
            <div className="text-left">
              <h1 className="text-3xl sm:text-4xl font-bold mb-3 dark:text-white">My Projects</h1>
            ...
            <Link href="https://github.com/Haskins2" target="_blank" rel="noopener noreferrer" className="w-full md:w-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {projects.map((project) => (
            <Card key={project.id} className="overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col h-[460px] md:h-[500px] dark:bg-zinc-800 dark:border-zinc-700">
              ...
              <div className="p-6 flex flex-col flex-1">
                <div className="mb-0">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 dark:text-white">{project.title}</h3>
